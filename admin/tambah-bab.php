...
if (isset($_POST['tambahBab'])) {
    if (tambahbab($_POST) > 0) {
        echo "<script>
        alert('Berhasil Tambah Bab')
        setTimeout(() => {
            window.location.href='materi.php?id=$idMateri'
        }, 500);
        </script>";
    }
}
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="materi.php?id=<?= $materi[
                  'id'
              ] ?>"><?= $materi['nama'] ?></a>
              <?php endforeach; ?>
              <br />
              <a class="collapse-item btn btn-primary" href="tambah-materi.php">
                Tambah Materi
              </a>
            </div>
          </div>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">Tambah Bab <?= $namaMateri[
                  'nama'
              ] ?></h1>
            </div>
            <div class="content">
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="editorlatihan" rows="3" name="latihan"></textarea>
                        <small>Kosongkan Jika Tidak Ada</small>
                    </div>
                    <button type="submit" class="btn btn-primary" name="tambahBab">Submit</button>
                </form>
            </div>
          </div>
          <!-- /.container-fluid -->
