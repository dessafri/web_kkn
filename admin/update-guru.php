...
if (isset($_POST['update'])) {
    if (updateGuru($_POST) > 0) {
        echo "<script>
      alert('Update Berhasil! Silahkan Login')
      setTimeout(() => {
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="daftar-guru.php">Daftar Guru</a>
            </div>
          </div>
        </li>
            ...
            >
              ...
              <form method="POST" action="">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control text-muted" id="exampleInputEmail1" aria-describedby="emailHelp" value='<?= $guru[0][
                      'nama'
                  ] ?>' name="nama">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1"> Nama </label>
                  <input type="hidden" class="form-control text-muted" id="exampleInputEmail1" aria-describedby="emailHelp" value='<?= $guru[0][
                      'id'
                  ] ?>' name="id">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1"> Email </label>
                  <input type="email" class="form-control text-muted" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $guru[0][
                      'email'
                  ] ?>" name="email">
                </div>
                 <div class="form-group">
